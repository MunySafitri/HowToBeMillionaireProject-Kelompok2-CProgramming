    ...
    if(arguments>2){//jika user memasukkan arguments lebih dari 2
        ...
        mainmenu:
            ...
            if(pil1 == 2){//program untuk menampilkan cara login
                ...
                strcat(storage,usernameinput);
                
                getchar();
                if((fip=fopen(storage,"r"))!=NULL){//jika username dan password sudah ada
                    system("cls");
       ...
       // printf("string1:%s\n",string[1]);
        // fflush();
        //printf("%d",strcmp(user[0],string[0]) == 0);
        if( (strcmp(user[0], string[0]) == 0) && (strcmp(user[1], string[1]) == 0) )
        {
            system("cls");
